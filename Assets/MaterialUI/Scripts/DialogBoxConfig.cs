...
namespace MaterialUI
{
    public class DialogBoxConfig : MonoBehaviour
    {
        ...
        [SerializeField] private bool canClickBackgroundToCancel;
        [SerializeField] private float animationDuration = 1f;

        [Space(10)] public RectTransform backgroundTransform;
        ...
        private void Update()
        {
            ...
            else if (state == 2)
            {
                ...
                {
                    if (darkenBackground)
                        backroundCanvasGroup.alpha = Anim.Quint.In(currentBackgroundAlpha, 0f, animDeltaTime,
        ...
        {
            if (canClickBackgroundToCancel) Close();
        }
