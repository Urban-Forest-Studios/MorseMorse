...
namespace MaterialUI
{
    ...
    public class RectTransformSnap : MonoBehaviour
    {
        ...
        public void Snap()
        {
            if (targetRect)
            {
                if (lastRect != new Rect(targetRect.position.x, targetRect.position.y, targetRect.sizeDelta.x,
                        targetRect.sizeDelta.y))
                {
                    lastRect = new Rect(targetRect.position.x, targetRect.position.y, targetRect.sizeDelta.x,
                        targetRect.sizeDelta.y);
