...
namespace MaterialUI
{
    public class InputFieldConfig : MonoBehaviour, ISelectHandler, IDeselectHandler
    {
        ...
        private float activeLineAlpha;

        private float activeLinePos;
        private RectTransform activeLineRect;
        private float animDeltaTime;

        private float animStartTime;
        private RectTransform displayTextRect;
        private bool dynamicHeight;

        private InputField inputField;

        private Color placeholderColor;

        private Color placeholderOffColor;
        private float placeholderPivot;
        private RectTransform placeholderRect;
        private float placeholderScale;
        private bool selected;

        private bool selectedBefore;
        ...
        private void Start()
        {
            ...
            if (inputField.lineType == InputField.LineType.MultiLineNewline ||
                inputField.lineType == InputField.LineType.MultiLineSubmit) dynamicHeight = true;
        }
        ...
        private void Update()
        {
            ...
            if (state == 1) // Activating
            {
                ...
                {
                    var tempColor = placeholderText.color;
                    ...
                    var tempVec3 = placeholderRect.localScale;
                    ...
                    var tempVec2 = placeholderRect.pivot;
            ...
            else if (state == 2) // Deactivating
            {
                ...
                {
                    var tempColor = placeholderText.color;
                    tempColor.r = Anim.Quint.Out(placeholderColor.r, placeholderOffColor.r, animDeltaTime,
                        animationDuration);
                    tempColor.g = Anim.Quint.Out(placeholderColor.g, placeholderOffColor.g, animDeltaTime,
                        animationDuration);
                    tempColor.b = Anim.Quint.Out(placeholderColor.b, placeholderOffColor.b, animDeltaTime,
                        animationDuration);
                    tempColor.a = Anim.Quint.Out(placeholderColor.a, placeholderOffColor.a, animDeltaTime,
                        animationDuration);
                    placeholderText.color = tempColor;
        ...
        private IEnumerator DelayedHeight()
        {
