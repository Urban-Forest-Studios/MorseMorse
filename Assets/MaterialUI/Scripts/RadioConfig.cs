    ...
    public class RadioConfig : MonoBehaviour
    {
        ...
        private void Update()
        {
            ...
            if (state == 1) // Turning on
            {
                ...
                {
                    dotRectTransform.localScale = Anim.Overshoot(new Vector3(currentDotSize, currentDotSize, 1f),
            ...
            else if (state == 2) // Turning off
            {
                if (animDeltaTime <= animationDuration)
                {
                    dotRectTransform.localScale = Anim.Sept.InOut(new Vector3(currentDotSize, currentDotSize, 1f),
