...
namespace MaterialUI
{
    public class Anim : MonoBehaviour
    {
        ...
        public static float Overshoot(float startValue, float endValue, float time, float duration)
        {
            ...
            if (time < 0.6069f)
                return differenceValue * (-Mathf.Sin(2 * Mathf.PI * time * time) / (2 * Mathf.PI * time * time) + 1) +
                       startValue;
            if (time < 0.8586f)
        ...
        public class Cube
        {
            ...
            public static float InOut(float startValue, float endValue, float time, float duration)
            {
                ...
                if (time < 1f) return differenceValue / 2 * time * time * time + startValue;
                time -= 2f;
        ...
        public class Quint
        {
            ...
            public static float InOut(float startValue, float endValue, float time, float duration)
            {
                ...
                if (time < 1f) return differenceValue / 2 * time * time * time * time * time + startValue;
                time -= 2f;
            ...
            public static float SoftOut(float startValue, float endValue, float time, float duration)
            {
                ...
                if (time < 0.497f) return differenceValue / 2 * time * time * time * time * time * 16 + startValue;
                time -= 2f;
        ...
        public class Sept
        {
            ...
            public static float InOut(float startValue, float endValue, float time, float duration)
            {
                ...
                if (time < 1f) return differenceValue / 2 * time * time * time * time * time * time * time + startValue;
                time -= 2f;
            ...
            public static float SoftOut(float startValue, float endValue, float time, float duration)
            {
                ...
                if (time < 0.341f) return differenceValue / 2 * time * time * time * 16 + startValue;
                time -= 2f;
                return differenceValue / 2 * (time * time * time * time * time * time * time * 0.03948f + 2) +
                       startValue;
            }
    ...
    public struct EZStruct
    {
        ...
        [SerializeField] public string animTag;

        [SerializeField] public GameObject targetGameObject;

        [SerializeField] public string targetComponent;

        [SerializeField] public string targetVariable;

        [SerializeField] public Component RealComponent;

        [SerializeField] public AnimType animationType;

        [SerializeField] public string variableType;

        [SerializeField] public ValType valueType;

        [SerializeField] public float duration;

        [SerializeField] public bool isField;

        [SerializeField] public int initialInt;

        [SerializeField] public int targetInt;

        [SerializeField] public float initialFloat;

        [SerializeField] public float targetFloat;

        [SerializeField] public Vector2 initialVector2;

        [SerializeField] public Vector2 targetVector2;

        [SerializeField] public Vector3 initialVector3;

        [SerializeField] public Vector3 targetVector3;

        [SerializeField] public Vector4 initialVector4;

        [SerializeField] public Vector4 targetVector4;

        [SerializeField] public Rect initialRect;

        [SerializeField] public Rect targetRect;
        ...
        [SerializeField] public bool modifyParameter1;

        [SerializeField] public bool modifyParameter2;

        [SerializeField] public bool modifyParameter3;

        [SerializeField] public bool modifyParameter4;

        [SerializeField] public float animStartTime;

        [SerializeField] public float animDeltaTime;

        [SerializeField] public float animationDuration;

        [SerializeField] public bool methodOnEnd;

        [SerializeField] public GameObject methodTargetGameObject;

        [SerializeField] public string methodTargetComponent;

        [SerializeField] public string methodTargetMethod;

        [SerializeField] public Component methodRealComponent;

        [SerializeField] public string methodParam;

        [SerializeField] public bool called;

        [SerializeField] public float delay;

        [SerializeField] public float delayValue;

        [SerializeField] public MethodInfo methodRealMethod;

        [SerializeField] public FieldInfo realField;

        [SerializeField] public PropertyInfo realProperty;
    }
