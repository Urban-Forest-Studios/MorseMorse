...
namespace MaterialUI
{
    ...
    {
        private static GameObject ripplePrefab;
        private static GameObject currentRipple;
        ...
        {
            currentRipple = Object.Instantiate(ripplePrefab);
        ...
        public static GameObject MakeRipple(Vector3 position, Transform parent, int size, float animSpeed,
            float startAlpha, float endAlpha, Color color)
        {
            currentRipple = Object.Instantiate(ripplePrefab);
            ...
            currentRipple.GetComponent<RippleAnim>()
                .MakeRipple(size, animSpeed, startAlpha, endAlpha, color, new Vector3(0, 0, 0));

            return currentRipple;
        }

        public static GameObject MakeRipple(Vector3 position, Transform parent, int size, float animSpeed,
            float startAlpha, float endAlpha, Color color, Vector3 endPosition)
        {
            currentRipple = Object.Instantiate(ripplePrefab);
            ...
            currentRipple.GetComponent<RippleAnim>()
                .MakeRipple(size, animSpeed, startAlpha, endAlpha, color, endPosition);
