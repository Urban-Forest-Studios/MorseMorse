        ...
        private void Update()
        {
            ...
            if (state == 1)
            {
                if (animDeltaTime <= animationDuration)
                {
                    ...
                    topTransform.localPosition = Anim.Quint.SoftOut(new Vector2(0f, 5f), new Vector2(9.4f, -0.7f),
                        animDeltaTime, animationDuration);
                    ...
                    bottomTransform.localPosition = Anim.Quint.SoftOut(new Vector2(0f, -5f), new Vector2(9.4f, 0.7f),
                        animDeltaTime, animationDuration);
            ...
            else if (state == 2)
            {
                if (animDeltaTime <= animationDuration)
                {
                    ...
                    topTransform.localPosition = Anim.Quint.SoftOut(new Vector2(9.4f, -0.7f), new Vector2(0f, 5),
                        animDeltaTime, animationDuration);
                    ...
                    bottomTransform.localPosition = Anim.Quint.SoftOut(new Vector2(9.5f, 0.7f), new Vector2(0f, -5f),
                        animDeltaTime, animationDuration);
