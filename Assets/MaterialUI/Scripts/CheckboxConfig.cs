...
namespace MaterialUI
{
    ...
    public class CheckboxConfig : MonoBehaviour
    {
        ...
        [HideInInspector] public bool changeTextColor;

        [HideInInspector] public Color textNormalColor;

        [HideInInspector] public Color textDisabledColor;

        [HideInInspector] public bool changeRippleColor;


        [HideInInspector] [SerializeField] private Image checkImage;

        [HideInInspector] [SerializeField] private Image frameImage;
        ...
        private void Update()
        {
            ...
            if (state == 1)
            {
                ...
                {
                    checkRectTransform.localScale = Anim.Overshoot(new Vector3(currentCheckSize, currentCheckSize, 1f),
                        new Vector3(1f, 1f, 1f), animDeltaTime, animationDuration);
            ...
            else if (state == 2)
            {
                ...
                {
                    checkRectTransform.localScale = Anim.Sept.InOut(new Vector3(currentCheckSize, currentCheckSize, 1f),
                        new Vector3(0f, 0f, 1f), animDeltaTime, animationDuration * 0.75f);
                    frameImage.color =
                        Anim.Sept.InOut(currentColor, offColor, animDeltaTime, animationDuration * 0.75f);
                    frameCanvasGroup.alpha =
                        Anim.Sept.InOut(currentFrameAlpha, 1f, animDeltaTime, animationDuration * 0.75f);

                    if (changeTextColor)
                        text.color = Anim.Quint.SoftOut(currentTextColor, textNormalColor, animDeltaTime,
