    ...
    public class SwitchConfig : MonoBehaviour
    {
        ...
        private void Update()
        {
            ...
            if (state == 1)
            {
                ...
                {
                    switchRectTransform.anchoredPosition = Anim.Quint.SoftOut(new Vector2(currentSwitchPosition, 0f),
                        new Vector2(8f, 0f), animDeltaTime, animationDuration);
            ...
            else if (state == 2)
            {
                if (animDeltaTime <= animationDuration * 0.75f)
                {
                    ...
                    backImage.color = Anim.Sept.InOut(currentBackColor, backOffColor, animDeltaTime,
