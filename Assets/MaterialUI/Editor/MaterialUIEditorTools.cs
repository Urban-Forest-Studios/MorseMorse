...
namespace MaterialUI
{
    ...
    public static class MaterialUIEditorTools
    {
        ...
        private static void SetupObject(string objectName)
        {
            ...
            if (notCanvas)
            {
                if (!Object.FindObjectOfType<EventSystem>())
                    Object.Instantiate(AssetDatabase.LoadAssetAtPath(
                        "Assets/MaterialUI/ComponentPrefabs/EventSystem.prefab",
                        typeof(GameObject))).name = "EventSystem";

                if (Object.FindObjectOfType<Canvas>())
                {
                    selectedObject = Object.FindObjectOfType<Canvas>().gameObject;
                }
                else
                {
                    selectedObject =
                        Object.Instantiate(AssetDatabase.LoadAssetAtPath(
                            "Assets/MaterialUI/ComponentPrefabs/Canvas.prefab",
        ...
        {
            theThing =
                Object.Instantiate(AssetDatabase.LoadAssetAtPath("Assets/MaterialUI/ComponentPrefabs/Background.prefab",
                    typeof(GameObject))) as GameObject;
        ...
        {
            theThing =
                Object.Instantiate(AssetDatabase.LoadAssetAtPath("Assets/MaterialUI/ComponentPrefabs/Panel.prefab",
                    typeof(GameObject))) as GameObject;
            SetupObject("Panel");
        }
        ...
        {
            theThing =
                Object.Instantiate(AssetDatabase.LoadAssetAtPath("Assets/MaterialUI/ComponentPrefabs/Text.prefab",
                    typeof(GameObject))) as GameObject;
            SetupObject("Text");
        }
        ...
        private static void CreateButtonFlat()
        {
            theThing =
                Object.Instantiate(AssetDatabase.LoadAssetAtPath(
                    "Assets/MaterialUI/ComponentPrefabs/Button - Flat.prefab",
                    typeof(GameObject))) as GameObject;
        ...
        private static void CreateButtonRaised()
        {
            theThing =
                Object.Instantiate(AssetDatabase.LoadAssetAtPath(
                    "Assets/MaterialUI/ComponentPrefabs/Button - Raised.prefab",
                    typeof(GameObject))) as GameObject;
            ...
            theThing =
                Object.Instantiate(
                    AssetDatabase.LoadAssetAtPath(
                        "Assets/MaterialUI/ComponentPrefabs/Round Button - Small - Flat.prefab",
                        typeof(GameObject))) as GameObject;
        ...
        private static void CreateSmallRoundButtonRaised()
        {
            theThing =
                Object.Instantiate(
                    AssetDatabase.LoadAssetAtPath(
                        "Assets/MaterialUI/ComponentPrefabs/Round Button - Small - Raised.prefab",
                        typeof(GameObject))) as GameObject;
        ...
        {
            theThing =
                Object.Instantiate(AssetDatabase.LoadAssetAtPath("Assets/MaterialUI/ComponentPrefabs/Checkbox.prefab",
                    typeof(GameObject))) as GameObject;
        ...
        {
            theThing =
                Object.Instantiate(AssetDatabase.LoadAssetAtPath("Assets/MaterialUI/ComponentPrefabs/RadioGroup.prefab",
                    typeof(GameObject))) as GameObject;
        ...
        {
            theThing =
                Object.Instantiate(AssetDatabase.LoadAssetAtPath("Assets/MaterialUI/ComponentPrefabs/Switch.prefab",
                    typeof(GameObject))) as GameObject;
            SetupObject("Switch");
        }
        ...
        {
            theThing =
                Object.Instantiate(AssetDatabase.LoadAssetAtPath("Assets/MaterialUI/ComponentPrefabs/TextInput.prefab",
                    typeof(GameObject))) as GameObject;
        ...
        {
            theThing =
                Object.Instantiate(AssetDatabase.LoadAssetAtPath("Assets/MaterialUI/ComponentPrefabs/Slider.prefab",
                    typeof(GameObject))) as GameObject;
            SetupObject("Slider");
        }
        ...
        private static void CreateSelectionBox()
        {
            theThing =
                Object.Instantiate(AssetDatabase.LoadAssetAtPath(
                    "Assets/MaterialUI/ComponentPrefabs/SelectionBox.prefab",
                    typeof(GameObject))) as GameObject;
        ...
        {
            theThing = Object.Instantiate(
                AssetDatabase.LoadAssetAtPath("Assets/MaterialUI/ComponentPrefabs/Divider - Light.prefab",
                    typeof(GameObject))) as GameObject;
            SetupObject("Divider");
            theThing.GetComponent<RectTransform>().anchoredPosition = Vector2.zero;
        }
        ...
        {
            theThing = Object.Instantiate(
                AssetDatabase.LoadAssetAtPath("Assets/MaterialUI/ComponentPrefabs/Divider - Dark.prefab",
                    typeof(GameObject))) as GameObject;
            SetupObject("Divider");
            theThing.GetComponent<RectTransform>().anchoredPosition = Vector2.zero;
        }
        ...
        {
            theThing = Object.Instantiate(
                AssetDatabase.LoadAssetAtPath("Assets/MaterialUI/ComponentPrefabs/List Item/ListView.prefab",
                    typeof(GameObject))) as GameObject;
        ...
        {
            theThing = Object.Instantiate(AssetDatabase.LoadAssetAtPath(
                "Assets/MaterialUI/ComponentPrefabs/List Item/List Item Single.prefab",
                typeof(GameObject))) as GameObject;
        ...
        {
            theThing = Object.Instantiate(AssetDatabase.LoadAssetAtPath(
                "Assets/MaterialUI/ComponentPrefabs/List Item/List Item Single Icon.prefab",
                typeof(GameObject))) as GameObject;
            SetupObject("List Item");
            theThing.GetComponent<RectTransform>().anchoredPosition = Vector2.zero;
        }
        ...
        {
            theThing = Object.Instantiate(AssetDatabase.LoadAssetAtPath(
                "Assets/MaterialUI/ComponentPrefabs/List Item/List Item Single Avatar.prefab",
                typeof(GameObject))) as GameObject;
            SetupObject("List Item");
            theThing.GetComponent<RectTransform>().anchoredPosition = Vector2.zero;
        }
        ...
        {
            theThing = Object.Instantiate(AssetDatabase.LoadAssetAtPath(
                "Assets/MaterialUI/ComponentPrefabs/List Item/List Item Single Icon Avatar.prefab",
                typeof(GameObject))) as GameObject;
            SetupObject("List Item");
            theThing.GetComponent<RectTransform>().anchoredPosition = Vector2.zero;
        }
        ...
        {
            theThing = Object.Instantiate(AssetDatabase.LoadAssetAtPath(
                "Assets/MaterialUI/ComponentPrefabs/List Item/List Item Double.prefab",
                typeof(GameObject))) as GameObject;
            SetupObject("List Item");
            theThing.GetComponent<RectTransform>().anchoredPosition = Vector2.zero;
        }
        ...
        {
            theThing = Object.Instantiate(AssetDatabase.LoadAssetAtPath(
                "Assets/MaterialUI/ComponentPrefabs/List Item/List Item Double Icon.prefab",
                typeof(GameObject))) as GameObject;
            SetupObject("List Item");
            theThing.GetComponent<RectTransform>().anchoredPosition = Vector2.zero;
        }
        ...
        {
            theThing = Object.Instantiate(AssetDatabase.LoadAssetAtPath(
                "Assets/MaterialUI/ComponentPrefabs/List Item/List Item Double Avatar.prefab",
                typeof(GameObject))) as GameObject;
            SetupObject("List Item");
            theThing.GetComponent<RectTransform>().anchoredPosition = Vector2.zero;
        }
        ...
        {
            theThing = Object.Instantiate(AssetDatabase.LoadAssetAtPath(
                "Assets/MaterialUI/ComponentPrefabs/List Item/List Item Double Icon Avatar.prefab",
                typeof(GameObject))) as GameObject;
            SetupObject("List Item");
            theThing.GetComponent<RectTransform>().anchoredPosition = Vector2.zero;
        }
        ...
        {
            theThing = Object.Instantiate(AssetDatabase.LoadAssetAtPath(
                "Assets/MaterialUI/ComponentPrefabs/List Item/List Item Triple.prefab",
                typeof(GameObject))) as GameObject;
            SetupObject("List Item");
            theThing.GetComponent<RectTransform>().anchoredPosition = Vector2.zero;
        }
        ...
        {
            theThing = Object.Instantiate(AssetDatabase.LoadAssetAtPath(
                "Assets/MaterialUI/ComponentPrefabs/List Item/List Item Triple Icon.prefab",
                typeof(GameObject))) as GameObject;
            SetupObject("List Item");
            theThing.GetComponent<RectTransform>().anchoredPosition = Vector2.zero;
        }
        ...
        {
            theThing = Object.Instantiate(AssetDatabase.LoadAssetAtPath(
                "Assets/MaterialUI/ComponentPrefabs/List Item/List Item Triple Avatar.prefab",
                typeof(GameObject))) as GameObject;
            SetupObject("List Item");
            theThing.GetComponent<RectTransform>().anchoredPosition = Vector2.zero;
        }
        ...
        {
            theThing = Object.Instantiate(AssetDatabase.LoadAssetAtPath(
                "Assets/MaterialUI/ComponentPrefabs/List Item/List Item Triple Icon Avatar.prefab",
                typeof(GameObject))) as GameObject;
            SetupObject("List Item");
            theThing.GetComponent<RectTransform>().anchoredPosition = Vector2.zero;
        }
        ...
        {
            theThing =
                Object.Instantiate(AssetDatabase.LoadAssetAtPath("Assets/MaterialUI/ComponentPrefabs/Nav Drawer.prefab",
                    typeof(GameObject))) as GameObject;
            SetupObject("Nav Drawer");
            theThing.GetComponent<RectTransform>().sizeDelta =
                new Vector2(theThing.GetComponent<RectTransform>().sizeDelta.x, 8f);
        ...
        {
            theThing =
                Object.Instantiate(AssetDatabase.LoadAssetAtPath("Assets/MaterialUI/ComponentPrefabs/App Bar.prefab",
                    typeof(GameObject))) as GameObject;
            SetupObject("App Bar");
            theThing.GetComponent<RectTransform>().sizeDelta = Vector2.zero;
            theThing.GetComponent<RectTransform>().anchoredPosition = Vector2.zero;
        ...
        private static void CreateScreenManager()
        {
            theThing =
                Object.Instantiate(AssetDatabase.LoadAssetAtPath(
                    "Assets/MaterialUI/ComponentPrefabs/ScreenManager.prefab",
                    typeof(GameObject))) as GameObject;
        ...
        {
            theThing =
                Object.Instantiate(AssetDatabase.LoadAssetAtPath("Assets/MaterialUI/ComponentPrefabs/Screen.prefab",
                    typeof(GameObject))) as GameObject;
            SetupObject("Screen");
            theThing.GetComponent<RectTransform>().sizeDelta = Vector2.zero;
            theThing.GetComponent<RectTransform>().anchoredPosition = Vector2.zero;
